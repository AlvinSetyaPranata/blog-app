...
export default function CardOverlay({ title, desc, src }) {
  return (
    <div className='rounded-md group relative'>
        <div className='absolute left-0 top-0 size-full bg-black opacity-0 group-hover:opacity-75 group-hover:transition-opacity group-hover:ease-in group-hover:duration-200 duration-200 ease-out flex flex-col justify-end p-8 rounded-md'>
